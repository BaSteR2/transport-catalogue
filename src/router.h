...
namespace graph {
    ...
    template <typename Weight>
    Router<Weight>::Router(const Graph& graph, Router<Weight>::RoutesInternalData data) 
        : graph_(graph)
    ...
    template <typename Weight>
    const typename Router<Weight>::RoutesInternalData& Router<Weight>::GetInternalData() const {
